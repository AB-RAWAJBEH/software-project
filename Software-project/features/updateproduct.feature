...
Scenario: Update missing product successfully
	...
	And  a product  name "cover" , type "water proof " , and the price "25", amount"7"
	When the product is Update missing from the system
	Then the product with name "cover" ,type "water proof" , and the price "25", amount"7" updated 
